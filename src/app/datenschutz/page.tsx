  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <a href="/" className="text-primary hover:underline text-sm mb-6 inline-block">ÔåÉ Zur├╝ck zur Startseite</a>
        <h1 className="text-4xl font-display font-bold mb-8">Datenschutzerkl├ñrung</h1>
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <p>Verantwortlicher f├╝r die Datenverarbeitung auf dieser Website ist:<br />Tolga G├╝nsal<br />E-Mail: hallo@guenlab.de</p>

          <h2 className="text-xl font-display font-semibold text-foreground">2. Hosting &amp; Server-Standort</h2>
          <p>Die Wortwende-Plattform wird auf eigenen Servern (ZimaOS, Deutschland) betrieben. Es findet kein Hosting durch Drittanbieter statt. Server-Logs (IP-Adresse, Zeitstempel, angeforderte URL) werden f├╝r maximal 30 Tage zur Missbrauchsabwehr gespeichert.</p>

          <h2 className="text-xl font-display font-semibold text-foreground">3. Erhebung und Verarbeitung personenbezogener Daten</h2>
          <p>Wir erheben und verarbeiten personenbezogene Daten nur, soweit dies f├╝r die Bereitstellung unserer Dienste erforderlich ist. Dazu geh├Âren: Name, E-Mail-Adresse, Lernfortschritte, Nutzungsstatistiken.</p>
          <p><strong>Google OAuth:</strong> Du kannst dich mit deinem Google-Konto anmelden. Dabei werden dein Name und deine E-Mail-Adresse von Google an uns ├╝bermittelt. Google erh├ñlt die Information, dass du unsere App nutzt. Die Datenschutzerkl├ñrung von Google gilt zus├ñtzlich: <a href="https://policies.google.com/privacy" className="text-primary hover:underline">policies.google.com/privacy</a>.</p>

          <h2 className="text-xl font-display font-semibold text-foreground">3. Zweck der Datenverarbeitung</h2>
          <p>Ihre Daten werden ausschlie├ƒlich zur Bereitstellung und Verbesserung unseres Lernangebots verwendet, einschlie├ƒlich: Personalisierung des Lernfortschritts, Bereitstellung von Statistiken, Versenden von Lernerinnerungen.</p>

          <h2 className="text-xl font-display font-semibold text-foreground">4. Rechtsgrundlage (Art. 6 DSGVO)</h2>
          <p>Die Verarbeitung erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) und zur Erf├╝llung unseres Leistungsvertrags (Art. 6 Abs. 1 lit. b DSGVO).</p>

          <h2 className="text-xl font-display font-semibold text-foreground">5. Speicherdauer</h2>
          <p>Ihre Daten werden nur so lange gespeichert, wie es f├╝r die Zwecke der Datenverarbeitung erforderlich ist oder gesetzliche Aufbewahrungspflichten bestehen.</p>

          <h2 className="text-xl font-display font-semibold text-foreground">6. Ihre Rechte</h2>
          <p>Sie haben das Recht auf: Auskunft (Art. 15 DSGVO), Berichtigung (Art. 16 DSGVO), L├Âschung (Art. 17 DSGVO), Einspruch (Art. 21 DSGVO), Daten├╝bertragbarkeit (Art. 20 DSGVO).</p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Daten&uuml;bermittlung:</strong> Deine Chat-Nachrichten werden an die DeepSeek-API gesendet, um eine KI-Antwort zu generieren. Es werden keine personenbezogenen Daten (Name, E-Mail) mitgesendet ÔÇô nur der Chat-Verlauf und dein CEFR-Sprachniveau.</li>
            ...
            <li><strong>Rechtsgrundlage:</strong> Die Verarbeitung erfolgt auf Grundlage deiner Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) und zur Erf&uuml;llung unseres Leistungsvertrags (Art. 6 Abs. 1 lit. b DSGVO). Du kannst den KI-Tutor jederzeit nicht nutzen ÔÇô alle anderen Funktionen bleiben verf&uuml;gbar.</li>
