    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Datenübermittlung:</strong> Deine Chat-Nachrichten werden an die DeepSeek-API gesendet, um eine KI-Antwort zu generieren. Es werden keine personenbezogenen Daten (Name, E-Mail) mitgesendet – nur der Chat-Verlauf und dein CEFR-Sprachniveau.</li>
            ...
            <li><strong>Rechtsgrundlage:</strong> Die Verarbeitung erfolgt auf Grundlage deiner Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) und zur Erfüllung unseres Leistungsvertrags (Art. 6 Abs. 1 lit. b DSGVO). Du kannst den KI-Tutor jederzeit nicht nutzen – alle anderen Funktionen bleiben verfügbar.</li>
